...
<body class="font-monserat">
            ...
            <div class="bg-white w-[68rem] shadow-lg rounded-xl">
                ...
                <div class="contentBox px-6">
                    <div class="content text-dark active">
                        <form class="max-w-sm mt-6 pb-7" id="form1">
                    ...
                    <div class="content text-dark">
                        <form class="max-w-sm mt-6 pb-2" id="form2">
                            <div class="grid-cols-2 w-[60rem] grid gap-x-20">
                                <div class="mb-5">
                    ...
                    <div class="content ml-4 text-dark">
                        ...
                        <button type="button" onclick="kirimData()" id="upload-button" data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="block mt-6 mx-[40%] text-white bg-blueFist hover:bg-bluSecond focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                            Upload
                        </button>
    ...
    <script>
        function kirimData() {
            ...
            formData.append(
                "namaLengkap",
                form1.querySelector('input[name="namaLengkap"]').value
            );
            formData.append(
                "jenisKelamin",
                form1.querySelector('input[name="jenisKelamin"]').value
            );
            formData.append(
                "tanggalLahir",
                form1.querySelector('input[name="tanggalLahir"]').value
            );
            formData.append("alamat", form1.querySelector('input[name="alamat"]').value);
            formData.append("kota", form1.querySelector('input[name="kota"]').value);
            formData.append("nisn", form1.querySelector('input[name="nisn"]').value);
            formData.append(
                "tempatlahir",
                form1.querySelector('input[name="tempatlahir"]').value
            );
            formData.append("agama", form1.querySelector('input[name="agama"]').value);
            formData.append(
                "provinsi",
                form1.querySelector('input[name="provinsi"]').value
            );
            formData.append(
                "telepon",
                form1.querySelector('input[name="telepon"]').value
            );
